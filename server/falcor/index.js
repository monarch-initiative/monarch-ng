...
var SService = require('./sservice');
var TService = require('./tservice');
var RService = require('./rservice');

// from: http://stackoverflow.com/questions/17575790/environment-detection-node-js-or-browser
var isNode = new Function("try {return this===global;}catch(e){return false;}"); /* eslint no-new-func: 0 */
var browserDB = !isNode();

var ratingService = new SService(browserDB);
var titleService = new TService(browserDB);
var recommendationService = new RService(browserDB);
...
var MyRouterBase = Router.createClass([
            ...
            return recommendationService.
                ...
                then(function(genrelist) {
                    ...
                    return pathSet.indices.map(function(index) {
                        ...
                        console.log('[', index, '] ', genrelist[index]);
                        return {
    ...
    // Promise<JSONGraphEnvelope>.
    {
        ...
        get: function (pathSet) {
            ...
            console.log('titleService.getTitles:', pathSet.titleIds);
    ...
    // }
    {
        ...
        get: function(pathSet) {
            console.log('pathSet:', pathSet, ' this.userId:', this.userId);
            return recommendationService.
                getGenreList(this.userId).
                then(function(genrelist) {
    ...
    // }
    {
        ...
        call: function(callPath, args) {
            ...
            var result = recommendationService.
                ...
                then(function(length) {
                    ...
                    console.log('genreLists.titles.push addMessageToRoom resultx:', resultx);
                    return resultx;
                });
            console.log('genreLists.titles.push result:', result);
            return result;
        }
    }
]);

function MyRouter(userId) {
